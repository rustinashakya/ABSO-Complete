                            ...
                            <form id="doctoraddForm" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="slug" type="text" name="slug" value="{{ old('slug') }}"
                                            placeholder="Slug" class="form-control @error('slug')
                                                is-invalid
                                            @enderror">
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="meta_keyword" cols="8" rows="3" placeholder="Keyword" class="form-control">{{ old('meta_keyword') }}</textarea>
