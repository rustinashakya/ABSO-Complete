...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Edit Health Library') }}</h1>
                </div>
                <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('healthlibrary.update', $health_library->id) }}">
                        @csrf
                        @method('post')
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="mb-3 form-group-translation col-md-6">
                                    ...
                                    <input id="title" type="text" name="title" value="{{ $health_library->title }}" placeholder="Title" class="form-control">
                                ...
                                <div class="mb-3 form-group-translation col-md-6">
                                    ...
                                    <input type="date" name="published_date" value="{{ $health_library->published_date }}" class="form-control">
                                ...
                                <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="link" type="text" name="link" value="{{$health_library->link }}"
                                ...
                                <div class="mb-3 form-group-translation col-md-12">
                                        <div class="mb-3 mt-3 form-group-translation col-md-6">
                                            ...
                                            <input type="hidden" name="thumbnail_1" value="{{ $health_library->thumbnail }}">
                                            <input type="file" class="form-control-file" id="exampleFormControlFile1"
                                                value="{{ old('thumbnail',$health_library->thumbnail) }}" name="thumbnail">
                                
                                            <div class="col-md-6">
                                                <div class="image-trap">
                                                    <a href="{{asset('storage/uploads/health_library_thumbnail/'.$health_library->thumbnail)}}" data-toggle="lightbox"
                                                        data-gallery="multiimages" data-title="" class=" img-responsive">
                                                        <picture>
                                                            <source media="(min-width:3840px)"
                                                                srcset="{{ asset('/storage/uploads/health_library_thumbnail/' . $health_library->thumbnail) }}" />
                                                            <source media="(min-width:2048px)"
                                                                srcset="{{ asset('/storage/uploads/health_library_thumbnail/thumbnail/large_' . $health_library->thumbnail) }}" />
                                
                                                            <source media="(min-width:1920px)"
                                                                srcset="{{ asset('/storage/uploads/health_library_thumbnail/thumbnail/medium_' . $health_library->thumbnail) }}" />
                                                            <source media="(min-width:768px)"
                                                                srcset="{{ asset('/storage/uploads/health_library_thumbnail/thumbnail/small_' . $health_library->thumbnail) }}" />
                                
                                                            <img src="{{ asset('/storage/uploads/health_library_thumbnail/thumbnail/vsmall_' . $health_library->thumbnail) }}"
                                                                alt="Image">
                                                        </picture>
                                                        {{-- <img class="img-thumbnail image_list" style="width:100%;"
                                                            src="{{asset('storage/uploads/health_library_thumbnail/'.$health_library->thumbnail)}}" alt="image"> --}}
                                                    </a>
                                                </div>
                                            </div>
