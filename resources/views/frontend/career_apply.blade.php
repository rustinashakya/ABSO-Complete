        ...
        <div class="container">
            <div class="row row-60">
                <div class="col-lg-12">
                    ...
                    @else
                        <h4 class="text-spacing-25 text-transform-none"><b>{{ $level->title }} Vacancy - Application Form</b>
                        </h4>
                    @endif
                    ...
                    <form method="post" action="{{ route('applicant.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="row row-20 gutters-20">
                            ...
                            <div class="col-md-6 col-lg-5">
                                <div class="form-wrap">
                                    <label class="text-black" for="name">Your Name <span
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-wrap">
                                    <label class="text-black" for="email">Your Email <span
                                            style="color: red;">*</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-wrap">
                                    <label class="text-black" for="cv">Upload Your CV <span
                                            style="color: red;">*</span></label> <br>
                                    <input class="form-input-file mt-2" id="cv" type="file" name="cv_file"
                                        accept=".pdf, .doc, .docx"> <br />
                                    <span id="file_upload_message">Only docx, doc and pdf files with less than 2MB are
                                        accepted.</span>
                                    <br>
                                    @error('cv_file')
                                        <span class="text-danger" id="name-error" style="color: red">{{ $message }}</span>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-wrap">
                                    <label class="text-black" for="position">Position <span
                                            style="color: red;">*</span></label>
                                    <select class="form-input @error('vacancy_id') is-invalid @enderror" id="position"
                                        ...
                                        @foreach ($positions as $position)
                                            <option value="{{ $position->id }}"
                                                {{ old('vacancy_id', @$applicant->vacancy_id || @$level->id) == $position->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-wrap">
                                    <label class="text-black" for="salary_expectation">Salary Expectation <span
                                            style="color: red;">*</span></label>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-wrap">
                                    <label class="text-black" for="experience">Years of Job Experience <span
                                            style="color: red;">*</span></label>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-wrap">
                                    <label class="text-black" for="high_level_education">Highest Level of Education <span
                                            style="color: red;">*</span></label>
                            ...
                            <div class="col-12">
                                <div class="form-wrap">
                                    <label class="text-black" for="training_description">Trainings completed on related
                                        field <span style="color: red;"></span></label>
                            ...
                            <div class="col-12">
                                <div class="form-wrap">
                                    <label class="text-black" for="cover_letter">Cover Letter <span
                                            style="color: red;">*</span></label>
                        ...
                        <button class="button button-primary" id="submit" type="submit">Send</button>
                    </form>
                </div>
