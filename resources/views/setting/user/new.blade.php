            ...
            <div class="row mb-2 mx-1">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">{{ __('Add Users') }}</li>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-body">
                        <form id="adminform" method="POST" action="{{route('admin.users.store')}}">
                            @csrf
                            @method('post')
                            <div class="row">
                                <div class="mb-3 form-group-translation col-md-6">
                                    ...
                                    <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Enter User Name" class="form-control">
                                    @if($errors->has('name'))
                            ...
                            <div class="row">
                                <div class="mb-3 form-group-translation col-md-12">
                                    ...
                                    <label class="flex flex-row items-center mt-2">
                                        <input type="checkbox" class="form-checkbox" name="roles[]" value="{{$role->id}}"><span class="ml-1 mr-3 text-black-800">{{ $role->name }}</span>
                                    </label>
                                    @endforeach
                                </div>
