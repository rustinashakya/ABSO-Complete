                        ...
                        <form method="POST" action="{{route('admin.roles.update',$role->id)}}">
                            ...
                            <div class="row">
                                <div class="mb-3 form-group-translation col-md-6">
                                    ...
                                    <input id="role_name" type="text" name="name" value="{{ old('name',$role->name) }}" placeholder="Enter role" class="form-control">
                                    @if($errors->has('name'))
                            ...
                            <div class="row">
                                ...
                                <label>Permissions: </label> <br>
                                    ...
                                    <label class="flex flex-row items-center mt-2">
                                        <input type="checkbox" class="form-checkbox" name="permissions[]" value="{{$permission->id}}" @if(count($role->permissions->where('id',$permission->id)))
                                        checked
                                        @endif
