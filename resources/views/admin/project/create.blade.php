                            ...
                            <form id="faqaddForm" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        is-invalid
                                    @enderror"
                                            id="exampleFormControlFile1" name="main_image[]" multiple>
                                        @error('main_image')
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        is-invalid
                                        @enderror">
                                            <option value="completed" {{ old('stage') == 'completed' ? 'selected' : '' }}>Complete</option>
                                            <option value="ongoing" {{ old('stage') == 'ongoing' ? 'selected' : '' }}>Ongoing</option>
                                        </select>
                                    </div>
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label class="form-check-label mb-3">
