        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Edit Project Translation') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <a title="Go Back" href="{{ route('admin.project.language.index', $project->id) }}"
                            ...
                            <li class="breadcrumb-item">
                                <a
                                    href="{{ route('admin.project.language.index', $project->id) }}">{{ __('Project Languages') }}</a>
                            </li>
                            <li class="breadcrumb-item">
                                {{ __('Edit Project Translation Language') }}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form id="mediaaddForm" method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.project.language.update', ['project_id'=>$project->id, 'id' => $project_language->id]) }}">
                                @csrf
                                @method('put')
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            @enderror">
                                                    @foreach ($languages as $language)
                                                        <option value="{{ $language->id }}"
                                                            {{ old('language_id', $project_language->language_id) == $language->id ? 'selected' : '' }}>
                                            ...
                                            <div class="mb-3 form-group-translation col-md-12">
                                                ...
                                                <input type="text" name="title" id="title"
                                                    value="{{ old('title', $project_language->title) }}"
                                            ...
                                            <div class="mb-3 form-group-translation col-md-12">
                                                <label for="short_description" class="form-label">{{ __('Short Description') }}<span
                                                        class="text-danger"> *</span>
                                                </label>
                                                <textarea name="short_description" id="short_description" class="form-control @error('short_description') is-invalid @enderror">{{ old('short_description', $project_language->short_description) }}</textarea>
                                            ...
                                            <div class="mb-3 form-group-translation col-md-12">
                                                ...
                                                <textarea class="form-control ckeditor @error('description')
                                                    is-invalid
                                                @enderror" name="description" id="description" rows="3" cols="8" >{{ old('description', $project_language->description) }}</textarea>
