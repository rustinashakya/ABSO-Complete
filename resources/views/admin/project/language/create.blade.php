        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Add Project Translation') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                {{ __('Add Project Translation Language') }}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form id="mediaaddForm" method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.project.language.store', $project->id) }}">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 form-group-translation col-md-12">
                                                ...
                                                <textarea class="form-control ckeditor @error('description')
                                                    is-invalid
                                                @enderror" name="description" id="description" rows="3" cols="8" >{{ old('description') }}</textarea>
