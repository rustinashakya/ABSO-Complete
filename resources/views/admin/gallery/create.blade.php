        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __(' Add Gallery') }}</h1>
                    </div>
                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        @enderror">
                                            <option value="document"
                                                @if (old('type') == 'document') {{ 'selected' }} @endif>Document
                                            </option>
                                            <option value="youtube_link"
                                                @if (old('type') == 'youtube_link') {{ 'selected' }} @endif>Youtube
                                            </option>
                                            <option value="image"
                                                @if (old('type') == 'image') {{ 'selected' }} @endif>Image</option>
                                        </select>
                                        @if ($errors->has('type'))
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6 js-document-block">
                                        ...
                                        <input id="document" type="file" name="document" accept=".doc, .docx, .pdf, .xls, .xlsx"
                                            value="{{ old('document') }}" placeholder="Document"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6 js-youtube-block">
                                        ...
                                        <input id="youtube_link" type="text" name="youtube_link"
                                            value="{{ old('youtube_link') }}" placeholder="Youtube Url"
