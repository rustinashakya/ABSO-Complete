                            ...
                            <form id="mediaaddForm" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="mb-3 form-group-translation col-md-4">
                                        ...
                                        <input type="text" name="slug" id="slug" value="{{ old('slug', $client->slug) }}" class="form-control @error('slug') 
                                        is-invalid
                                    ...
                                    <div class="mb-3 form-group-translation col-md-4">
                                        ...
                                        <input type="text" name="designation" id="designation" value="{{ old('designation', $client->designation) }}" class="form-control @error('designation') 
                                        is-invalid
                                    ...
                                    <div class="mb-3 form-group-translation col-md-4">
                                        ...
                                        <input type="file" name="profile_image" id="profile_image" class=" @error('profile_image') 
                                        is-invalid
                                        @enderror" placeholder="profile_image" />
                                        @if ($client->profile_image)
                                            <img src="{{ asset('storage/uploads/clients/profile_image/thumbnail/admin_' . $client->profile_image) }}" alt="Profile Image" class="mt-2" />
                                        @endif
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="organisation_logo" class="form-label">Organisation Logo <span
                                                class="text-danger"></span> </label>
                                        <p class="text-blue">Note: Please upload image of size 150px X 150px.</p>
                                        <input type="file" name="organisation_logo" id="organisation_logo"
                                            class="form-control-file @error('organisation_logo') 
                                        is-invalid
                                        @enderror" />
                                        @if ($client->organisation_logo)
                                            <img src="{{ asset('storage/uploads/clients/organisation_logo/thumbnail/admin_' . $client->organisation_logo) }}"
                                                alt="Profile Image" height="200" class="mt-2" />
                                            <br>
                                        @endif
                                    ...
                                    {{-- <div class="mb-3 form-group-translation col-md-6">
                                        <label for="url" class="form-label">Organisation Website <span
                                                class="text-danger"></span> </label>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="url" class="form-label">Description <span
                                                class="text-danger"></span> </label>
                                        <textarea name="description" cols="8" rows="3" placeholder="Description" class="form-control ckeditor">{{ old('description', $client->description) }}</textarea>

                                        @if ($errors->has('description'))
                                            <span style="color:red;">{{ $errors->first('description') }}</span>
                                        @endif --}}

                                        {{-- </div><div class="mb-3 form-group-translation col-md-12">
                                        <label for="html_title" class="form-label">Html Title <span class="text-danger"></span> </label>
                                        <textarea name="html_title" cols="8" rows="3" placeholder="Html Title" class="form-control @error('html_title') is-invalid @enderror">{{ old('html_title', $client->html_title) }}</textarea>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="meta_description" cols="8" rows="3" placeholder="Meta Description" class="form-control @error('meta_description') is-invalid @enderror">{{ old('meta_description', $client->meta_description) }}</textarea>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="meta_keyword" cols="8" rows="3" placeholder="Meta Keyword" class="form-control @error('meta_keyword') is-invalid @enderror">{{ old('meta_keyword', $client->meta_keyword) }}</textarea>
