        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Edit Vacancies') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <a title="Go Back" href="{{ route('admin.vacancy.index') }}"
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.vacancy.index') }}">{{ __('Vacancies') }}</a>
                            </li>
                            <li class="breadcrumb-item">
                                {{ __('Edit Vacancies') }}
                            </li>
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form id="mediaaddForm" method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.vacancy.update', $vacancy->id) }}">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="title" type="text" name="title"
                                            value="{{ old('title', $vacancy->title) }}" placeholder="Job Title"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="slug" type="text" name="slug"
                                            value="{{ old('slug', $vacancy->slug) }}" placeholder="Slug"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="short_description" class="form-label">Short Description <span
                                                class="text-danger">*</span> </label>
                                        <textarea name="short_description" id="short_description" cols="8" rows="3" placeholder="Short Description"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="vacancy_level_id" class="form-label"><span>{{ __('Level') }} <span
                                                    class="text-danger">*</span></span></label>
                                        <select name="vacancy_level_id" id="vacancy_level_id"
                                            class="form-control @error('vacancy_level_id')
                                            is-invalid
                                        @enderror">
                                            <option value="">Select Level</option>
                                            @foreach ($levels as $level)
                                                <option value="{{ $level->id }}"
                                                    {{ old('vacancy_level_id', $vacancy->vacancy_level_id) == $level->id ? 'selected' : '' }}>
                                                    {{ $level->name }}
                                                </option>
                                            @endforeach
                                        </select>

                                        @if ($errors->has('vacancy_level_id'))
                                            <span style="color:red;">{{ $errors->first('vacancy_level_id') }}</span>
                                        @endif
                                    </div>

                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="deadline" class="form-label"><span>{{ __('Deadline') }} <span
                                                    class="text-danger">*</span></span></label>
                                        <input id="deadline" type="date" name="deadline"
                                            value="{{ old('deadline', $vacancy->deadline) }}"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <div class="form-group-translation" style="overflow: hidden;">
                                            ...
                                            <img src="{{ asset('storage/uploads/vacancy/image/thumbnail/admin_' . $vacancy->image) }}" alt="image" class="mt-1" />
                                            @if ($errors->has('image'))
                                        ...
                                        <div class="d-flex">
                                            <div class="form-check form-check-inline" style="margin-right: 10px;">
                                                <input class="form-check-input @error('status') is-invalid @enderror"
                                                    type="checkbox" value="active" name="status" id="statusYes"
                                                    {{ old('status', $vacancy->status) == 'active' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="statusYes">Yes</label>
                                            </div>

                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input @error('status') is-invalid @enderror"
                                                    type="checkbox" value="inactive" name="status" id="statusNo"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="reports_to" class="form-label"><span>{{ __('Reports To') }} <span
                                                    class="text-danger"> </span></span></label>
                                        <input id="reports_to" type="text" name="reports_to" value="{{ old('reports_to', $vacancy->reports_to) }}" placeholder="Reports To"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="Meta title"
                                            class="form-label">{{ __('HTML Title') }} <span class="text-danger"> *</span></label>
                                        <textarea name="html_title" placeholder="HTML Title" id="ckeditor_2"
                                            class="form-control @error('html_title')
                                            is-invalid
                                        @enderror">{{ old('html_title', $vacancy->html_title) }}</textarea>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="Meta Description"
                                            class="form-label">{{ __('Meta Description') }}<span class="text-danger"> *</span></label>
                                        <textarea cols="8" rows="3" name="meta_description" placeholder="Meta Description" id="ckeditor_2"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="Meta Keyword" class="form-label">{{ __('Meta Keyword') }}<span class="text-danger"> *
                                            </span></label>
                                        <textarea name="meta_keyword" id="ckeditor_3" cols="8" rows="3" placeholder="Keyword"
