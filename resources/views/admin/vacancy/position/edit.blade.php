        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Edit Vacancy Position') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <a title="Go Back" href="{{ route('admin.vacancy.position.index') }}"
                            ...
                            <li class="breadcrumb-item">
                            <a href="{{ route('admin.vacancy.position.index') }}">{{ __('Levels') }}</a>
                            </li>
                            <li class="breadcrumb-item">
                                {{ __('Edit Position') }}
                            </li>
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form id="mediaaddForm" method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.vacancy.position.update', $position->id) }}">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="TItle" class="form-label"><span>Title <span class="text-danger">*</span></span></label>
                                        <input id="title" type="text" name="name" value="{{ old('title', $position->name) }}"
                                            placeholder="Title"
