    ...
    <div class="content-header px-3">
        <div class="container-fluid">
            <div class="row mb-2 mx-1">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Add Vacancies') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a title="Go Back" href="{{ route('admin.vacancy.index') }}" class="btn btn-secondary btn-sm previous round"> <i class="fas fa-arrow-left" aria-hidden="true"></i></a> &nbsp;&nbsp;
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-body">
                        <form id="mediaaddForm" method="POST" enctype="multipart/form-data" action="{{ route('admin.vacancy.store') }}">
                            @csrf
                            <div class="row">
                                <div class="mb-3 form-group-translation col-md-6">
                                    <label for="Title" class="form-label">Job Title <span class="text-danger">*</span> </label>
                                    <input id="title" type="text" name="title" value="{{ old('title') }}" placeholder="Job Title" class="form-control @error('title')
                                                is-invalid
                                            @enderror">
                                ...
                                <div class="mb-3 form-group-translation col-md-6">
                                    ...
                                    <input id="slug" type="text" name="slug" value="{{ old('slug') }}" placeholder="Slug" class="form-control @error('slug')
                                                is-invalid
                                            @enderror">
                                ...
                                <div class="mb-3 form-group-translation col-md-6">
                                    <label for="vacancy_level_id" class="form-label"><span>{{ __('Level') }} <span class="text-danger">*</span></span></label>
                                    <select name="vacancy_level_id" id="vacancy_level_id" class="form-control @error('vacancy_level_id')
                                            is-invalid
                                        @enderror">
                                        <option value="">Select Level</option>
                                        @foreach ($levels as $level)
                                        <option value="{{ $level->id }}" {{ old('vacancy_level_id') == $level->id ? 'selected' : '' }}>
                                            {{ $level->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3 form-group-translation col-md-6">
                                    <label for="deadline" class="form-label"><span>{{ __('Deadline') }} </span> <span class="text-danger">*</span> </label>
                                    <input id="deadline" type="date" name="deadline" value="{{ old('deadline') }}" class="form-control @error('deadline')
                                            is-invalid
                                        @enderror">
                                ...
                                <div class="mb-3 form-group-translation col-md-12">
                                    ...
                                    <input id="reports_to" type="text" name="reports_to" value="{{ old('reports_to') }}" placeholder="Reports To" class="form-control @error('reports_to') is-invalid @enderror">
                                ...
                                <div class="mb-3 form-group-translation col-md-12">
                                    ...
                                    <input name="html_title" type="text" placeholder="HTML Title" id="ckeditor_2" value="{{ old('html_title') }}" class="form-control @error('html_title')
                                            is-invalid
                                        @enderror">
