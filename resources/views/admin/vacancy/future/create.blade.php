    ...
    <div class="content-header px-3">
        <div class="container-fluid">
            <div class="row mb-2 mx-1">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Add Future Position') }}</h1>
                </div>
                <div class="col-sm-6">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-body">
                        <form id="mediaaddForm" method="POST" enctype="multipart/form-data" action="{{ route('admin.vacancy.future.store') }}">
                            @csrf
                            <div class="row">
