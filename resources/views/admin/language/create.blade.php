        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Add Language') }}</h1>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <form id="mediaaddForm" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <select id="list_id" name="list_id" class="form-control @error('list_id')
                                            is-invalid
                                        @enderror">
                                            @foreach ($lists as $list)
                                                <option value="{{ $list->id }}" {{ old('list_id') == $list->id ? 'selected' : '' }}>{{ $list->name }} - {{ $list->flag }}</option>
                                            @endforeach
                                        </select>
