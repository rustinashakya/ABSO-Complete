        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Edit Investment') }}</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form id="faqaddForm" method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.investment.update', $investment->id) }}">
                                @csrf
                                @method('put')
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="title" type="text" name="title"
                                            value="{{ old('title', $investment->title) }}" placeholder="Title"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="slug" type="text" name="slug"
                                            value="{{ old('slug', $investment->slug) }}" placeholder="Slug"
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        is-invalid
                                    @enderror">{{ old('short_description', $investment->short_description) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        is-invalid
                                    @enderror">{{ old('description', $investment->description) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="capital" class="form-label"><span id="capitalLabel">Capital</span>
                                            <span class="text-danger">*</span> </label>
                                        <input id="capital" type="text" name="capital"
                                            value="{{ old('capital', $investment->capital) }}" placeholder="Capital"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="start_year" class="form-label"><span id="start_year">Start Year</span>
                                            <span class="text-danger">*</span> </label>
                                        <input id="start_year" type="text" name="start_year"
                                            value="{{ old('start_year', $investment->start_year) }}"
                                            placeholder="Start Year"
                                            class="form-control @error('start_year')
                                        is-invalid
                                    @enderror">
                                        @if ($errors->has('start_year'))
                                            <span style="color:red;">{{ $errors->first('start_year') }}</span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="payback_period" class="form-label"><span id="payback_period">Payback
                                                Period</span> <span class="text-danger">*</span> </label>
                                        <input id="payback_period" type="text" name="payback_period"
                                            value="{{ old('payback_period', $investment->payback_period) }}"
                                            placeholder="Payback Period"
                                            class="form-control @error('payback_period')
                                        is-invalid
                                    @enderror">
                                        @if ($errors->has('payback_period'))
                                            <span style="color:red;">{{ $errors->first('payback_period') }}</span>
                                        @endif
                                    </div>

                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="roi" class="form-label"><span id="roiLabel">ROI</span> <span
                                                class="text-danger">*</span> </label>
                                        <input id="roi" type="text" name="roi"
                                            value="{{ old('roi', $investment->roi) }}" placeholder="ROI"
                                            class="form-control @error('roi')
                                        is-invalid
                                    @enderror">
                                        @if ($errors->has('roi'))
                                            <span style="color:red;">{{ $errors->first('roi') }}</span>
                                        @endif
                                    </div>
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="page_id" class="form-label">Sector <span class="text-danger"></span>
                                        </label>
                                        ...
                                        @enderror">
                                            ...
                                            @foreach ($pages as $page)
                                                <option value="{{ $page->id }}"
                                                    {{ old('page_id', $investment->page_id) == $page->id ? 'selected' : '' }}>
                                                    {{ $page->name }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        @enderror">
                                            ...
                                            @foreach ($projectTypes as $projectType)
                                                <option value="{{ $projectType->id }}"
                                                    {{ old('project_type_id', $investment->project_type_id) == $projectType->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="Status" class="form-label">Stage: <span class="text-danger"></span>
                                        </label>
                                        ...
                                        @enderror">
                                            <option value="completed"
                                                {{ old('stage', $investment->stage) == 'completed' ? 'selected' : '' }}>
                                                Complete</option>
                                            <option value="ongoing"
                                                {{ old('stage', $investment->stage) == 'ongoing' ? 'selected' : '' }}>
                                                Ongoing</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="exampleFormControlFile1">
                                            <span>Main Image: <span class="text-danger"
                                                    style="font-size: 12px;"></span></span>
                                        </label>
                                        <p class="text-blue">Note: Please upload image of size 1340px X 960px.</p>
                                    ...
                                    @enderror"
                                        ...
                                        @enderror
                                        <br>
                                        <img src="{{ asset('/storage/uploads/investment/main_image/thumbnail/admin_' . $investment->main_image) }}" alt="image" >
                                    </div>

                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="exampleFormControlFile2">
                                            <span>Mobile Image: <span class="text-danger"
                                                    style="font-size: 12px;"></span></span>
                                        </label>
                                        ...
                                        is-invalid
                                    @enderror"
                                            id="exampleFormControlFile2" accept=".jpg, .jpeg, .png" name="mobile_image">
                                        @error('mobile_image')
                                            <span style="color:red;">{{ $message }}</span>
                                        @enderror
                                        <br>
                                        <img src="{{ asset('/storage/uploads/investment/mobile_image/thumbnail/admin_' . $investment->mobile_image) }}" alt="image" >
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="html_title" class="form-label">Html
                                            Title<span class="text-danger"> *</span></label>
                                        <input type="text" name="html_title" id="html_title"
                                            class="form-control @error('html_title')
                                            is-invalid
                                        @enderror"
                                            value="{{ old('html_title', $investment->html_title) }}" placeholder="Html Title" />
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="meta_description" id="editor" cols="8" rows="3" placeholder="Meta Description"
                                            class="form-control">{{ old('meta_description', $investment->meta_description) }}</textarea>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="meta_keyword" id="meta_keyword" cols="8" rows="3" placeholder="Meta Keyword"
                                            class="form-control @error('meta_keyword')
                                                    is-invalid
                                                @enderror">{{ old('meta_keyword', $investment->meta_keyword) }}</textarea>
