        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Edit Investment Translation') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <a title="Go Back" href="{{ route('admin.project.language.index', $investment->id) }}"
                            ...
                            <li class="breadcrumb-item">
                                <a
                                    href="{{ route('admin.project.language.index', $investment->id) }}">{{ __('Investment Languages') }}</a>
                            </li>
                            <li class="breadcrumb-item">
                                {{ __('Edit Investment Translation Language') }}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form id="mediaaddForm" method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.investment.language.update', ['investment_id'=> $investment->id, 'id' => $investmentLanguage->id]) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="mb-3 form-group-translation col-md-7">
                                        <div class="row">
                                            <div class="mb-1 form-group-translation col-md-12">
                                                <label for="language_id" class="form-label">{{ __('Language') }}<span
                                            ...
                                            @enderror">
                                                    @foreach ($languages as $language)
                                                        <option value="{{ $language->id }}"
                                                            {{ old('language_id', $investmentLanguage->language_id) == $language->id ? 'selected' : '' }}>
                                            ...
                                            <div class="mb-3 form-group-translation col-md-12">
                                                ...
                                                <input type="text" name="title" id="title"
                                                    value="{{ old('title', $investmentLanguage->title) }}"
                                            ...
                                            <div class="mb-3 form-group-translation col-md-12">
                                                ...
                                                <textarea class="form-control ckeditor @error('description')
                                                    is-invalid
                                                @enderror" name="description" id="description" rows="3" cols="8" >{{ old('description', $investmentLanguage->description) }}</textarea>
