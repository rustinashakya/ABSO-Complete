        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Add Investment') }}</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form id="faqaddForm" method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.investment.store') }}">
                                @csrf
                                @method('post')

                                <!-- <div class="container-fluid"> -->
                                <input type="hidden" name="type_of_service" value="investment" />
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="capital" type="text" name="capital" value="{{ old('capital') }}"
                                            placeholder="Capital"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="start_year" type="text" name="start_year"
                                            value="{{ old('start_year') }}" placeholder="Start Year"
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="payback_period" type="text" name="payback_period"
                                            value="{{ old('payback_period') }}" placeholder="Payback Period"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="roi" class="form-label"><span id="roiLabel">ROI</span> <span
                                                class="text-danger">*</span> </label>
                                        <input id="roi" type="text" name="roi" value="{{ old('roi') }}"
                                            placeholder="ROI"
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="exampleFormControlFile1">
                                            <span>Main Image: <span class="text-danger" style="font-size: 12px;"></span></span>
                                        </label>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="exampleFormControlFile2">
                                            <span>Mobile Image: <span class="text-danger" style="font-size: 12px;"></span></span>
                                        </label>
