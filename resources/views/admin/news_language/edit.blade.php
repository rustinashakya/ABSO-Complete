        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('News Translation') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <a title="Go Back" href="{{ route('admin.campaign.language.index', $news->id) }}"
                            ...
                            <li class="breadcrumb-item">
                                <a
                                    href="{{ route('admin.news.language.index', $news->id) }}">{{ __('News Languages') }}</a>
                            </li>
                            <li class="breadcrumb-item">
                                {{ __(' Edit News Translation') }}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form id="mediaaddForm" method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.news.language.update', [$news->id, $newsLanguage->id]) }}">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-3 form-group-translation col-md-12">
                                            <label for="TItle" class="form-label">{{ __('Description') }} <span
                                                    class="text-danger">*</span> </label>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-8">
                                            ...
                                            @enderror">
                                                    @foreach ($languages as $language)
                                                        <option value="{{ $language->id }}"
                                                            {{ old('language_id', $newsLanguage->language_id) == $language->id ? 'selected' : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 form-group-translation col-md-12">
                                                ...
                                                <input type="text" name="title" id="title"
                                                    value="{{ old('title', $newsLanguage->title) }}"
                                        ...
                                        <div class="row">
                                            <div class="mb-3 form-group-translation col-md-12">
                                                ...
                                                <textarea  name="description" id="description" cols="30" rows="10" class="form-control ckeditor @error('description')
                                                    is-invalid
                                                @enderror">{{ old('description', $newsLanguage->description) }}</textarea>
