        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __(' Edit Static Page') }}</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.static.pages.update', $page->id) }}">
                                @csrf
                                @method('put')
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="name" type="text" name="name"
                                            value="{{ old('name', $page->name) }}" placeholder="Title" class="form-control @error('name')
                                                is-invalid
                                            @enderror">
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <input id="slug" type="text" name="slug"
                                            value="{{ old('slug', $page->slug) }}" placeholder="Slug" class="form-control @error('slug')
                                                is-invalid
                                            @enderror">
                                    ...
                                    {{-- <div class="mb-3 form-group-translation col-md-4">
                                        <label for="sub_title" class="form-label">Sub-title <span
                                                class="text-danger">*</span></label>
                                        <input id="sub_title" type="text" name="sub_title" value="{{ old('sub_title', $page->sub_title) }}"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="description" id="editor-1" cols="20" rows="10" placeholder="Content"
                                            class="form-control ckeditor @error('description')
                                                is-invalid
                                            @enderror">{{ old('description', $page->description) }}</textarea>
                                ...
                                {{-- <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <input id="html_title" type="text" name="html_title"
                                            value="{{ old('html_title', $page->html_title) }}" placeholder="HTML Title"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="meta_description" id="" cols="8" rows="3" placeholder="Meta Description"
                                            class="form-control @error('meta_description')
                                                is-invalid
                                            @enderror">{{ old('meta_description', $page->meta_description) }}</textarea>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="meta_keyword" id="" cols="8" rows="3" placeholder="Meta Keyword"
                                            class="form-control @error('meta_keyword')
                                                is-invalid
                                            @enderror">{{ old('meta_keyword', $page->meta_keyword) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <select id="type_div1" name="media_type" class="form-control @error('media_type')
                                            ...
                                            <option id="youtube1" data-youtube="youtube" value="youtube1"
                                                @if ($page->youtube_link != null) selected @endif>Youtube</option>
                                            <option value="image1" data-image="image"
                                                @if ($page->main_image != null) selected @endif>Image</option>
                                        </select>
                                        @if ($errors->has('type'))
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6" id="media-input-container">
                                        <div id="showyoutube1" class="myDiv1 youtube_div1">
                                            ...
                                            <input id="youtube_link" type="text" name="youtube_link"
                                                value="{{ old('youtube_link', $page->youtube_link) }}"
                                        ...
                                        <div class="div myDiv1 image_div1 mb-3" id="showimage1">
                                            ...
                                            <p class="text-blue">Note: Please upload image of size 1670px X 840px.</p>
                                            ...
                                            @if ($page->main_image)
                                                <img src="{{ asset('/storage/uploads/static_pages/main_image/thumbnail/admin_' . $page->main_image) }}"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12 image_div1" id="showimage2">
                                        ...
                                        @if ($page->mobile_image)
                                            <img src="{{ asset('/storage/uploads/static_pages/mobile_image/' . $page->mobile_image) }}"
                                                height="100" class="mt-2">
                                        @endif
                                        <br>
