                            ...
                            <div class="card card-body">
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="description" cols="8" rows="3" placeholder="Description"
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        <label for="Type" class="form-label">Media Type <span
                                                class="text-danger">*</span></label>
                                        <select id="type_div1" name="media_type"
                                            class="form-control @error('media_type')
                                                is-invalid
                                            @enderror">
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6" id="media-input-container">
                                        ...
                                        <div class="myDiv1 image_div1" id="showimage1">
                                            <label for="exampleFormControlFile1">Main Image
                                                <span class="text-danger"> </span>
                                            </label>
                                            <p class="text-blue">Note: Please upload image of size 1540px X 850px.</p>
                                            <input type="file" accept=".jpg, .jpeg, .png"
                                                class="form-control-file @error('main_image')
                                                is-invalid
                                            @enderror"
                                                id="exampleFormControlFile1" name="main_image" accept=".jpg, .jpeg, .png"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6 image_div1" id="showimage2">
                                        <label for="exampleFormControlFile2">Mobile Image
                                            <span class="text-danger"> </span>
                                        </label>
                                        ...
                                        <input type="file" accept=".jpg, .jpeg, .png"
                                            class="form-control-file @error('mobile_image')
                                                is-invalid
                                            @enderror"
                                            id="exampleFormControlFile2" name="mobile_image" accept=".jpg, .jpeg, .png"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6 image_div1" id="showimage2">
                                        ...
                                        <input type="number"
                                            ...
                                            class="form-control @error('order_by')
                                                is-invalid
                                            @enderror"
                                            id="order_by" name="order_by" value="{{ old('order_by') }}">
