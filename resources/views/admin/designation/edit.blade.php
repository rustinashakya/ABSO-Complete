        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Edit Designation') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <a title="Go Back" href="{{ route('admin.designation.index') }}"
                            ...
                            <li class="breadcrumb-item">
                            <a href="{{ route('admin.designation.index') }}">{{ __('Designations') }}</a>
                            </li>
                            <li class="breadcrumb-item">
                                {{ __('Edit Designation') }}
                            </li>
                    ...
                    <div class="container-fluid">
                        <div class="card card-body">
                            <form id="mediaaddForm" method="POST" enctype="multipart/form-data"
                                action="{{ route('admin.designation.update', $designation->id) }}">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="title" class="form-label">Title <span class="text-danger">*</span> </label>
                                        <input type="text" name="title" id="title" value="{{ old('title', $designation->title) }}" class="form-control @error('title') 
                                        is-invalid
