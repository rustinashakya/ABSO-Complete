...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __(' Add Testimonial') }}</h1>
                </div>
                <div class="col-sm-6">
        ...
        <section class="content">
            ...
            @if (session('message'))
                ...
                <div class="card card-body">
                    <form id="testimonialaddForm" method="POST" enctype="multipart/form-data" action="{{ route('testimonial.store') }}">
                        @csrf
                        @method('post')
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <div id="showyoutube1" class="row myDiv1 youtube_div1">

                                            <label for="Youtube Link" class="form-label"><span>Testimonial Link*</span></label>
                                ...
                                <div class="mb-3 form-group-translation col-md-12">
                                    <label for="Name of office" class="form-label"><span>Testimonial Image</span>*</label>
