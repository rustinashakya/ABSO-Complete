...
<body>
    <div>
        ...
        <div style="padding: 15px;letter-spacing: 0.2px;">
            ...
            <p>Your payment for booking an Appointment in Hope Fertility and Diagnostic has been successfully processed.</p>
            <p>We would like to confirm that the following appointment has been fixed.</p><br>
                {{-- Thank you for being a part of Hope Fertility and Diagnostic Private Limited. We look forward to serving you and providing an enriching experience for the year ahead.</p> --}}
