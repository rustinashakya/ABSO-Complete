            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.faq.update', $faq->id) }}">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 form-group-translation col-md-12">
                                    ...
                                    <input id="question" type="text" name="question" value="{{ old('question' ,$faq->question) }}" placeholder="Question " class="form-control">
                            ...
                            <div class="row">
                                <div class="mb-3 form-group-translation col-md-12">
                                    ...
                                    <textarea name="answer" id="editor" cols="8" rows="3" placeholder="Answer" class="form-control">{{ old('answer' , $faq->answer) }}</textarea>
