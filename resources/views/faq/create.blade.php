            ...
            <div class="row mb-2 mx-1">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="mr-2">
                            <a title="Go Back" href="{{route('admin.faq.index')}}" class="btn btn-secondary btn-sm previous round"> <i class="fas fa-arrow-left" aria-hidden="true"></i></a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.dashboard') }}">{{ __('Home') }}</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.faq.index') }}">{{ __('FAQs') }}</a>
                        </li>
                        <li class="breadcrumb-item">
                            {{ __('Add FAQ') }}
                        </li>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-body">
                        <form id="faqaddForm" method="POST" enctype="multipart/form-data" action="{{ route('admin.faq.store') }}">
                            @csrf
                            @method('post')
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 form-group-translation col-md-12">
                                    <label for="Question" class="form-label"><span id="questionLabel">Question</span> <span class="text-danger">*</span> </label>
                                    <input id="question" type="text" name="question" value="{{ old('question') }}" placeholder="Question" class="form-control">
                            ...
                            <div class="row">
                                <div class="mb-3 form-group-translation col-md-12">
                                    <label for="answer" class="form-label">
                                        <span id="answerLabel">Answer </span>
                                        <span class="text-danger">*</span>
                                    </label>
                                    <textarea name="answer" id="answer" cols="8" rows="3" placeholder="Answer" class="form-control">{{ old('answer') }}</textarea>
