...
class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            //images
            'main_image' => 'nullable|array|min:1',
            'main_image.*' => 'nullable|mimes:jpeg,png,jpg,gif,svg,pdf|max:2048|dimensions:width=1340,height=960',
            'mobile_image' => 'nullable|array|min:1',
            'mobile_image.*' => 'nullable|mimes:jpeg,png,jpg,gif,svg,pdf|max:2048|dimensions:width=767,height=767',
